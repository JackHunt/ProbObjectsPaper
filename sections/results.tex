...
\begin{figure}[!t]
	\centering
	\begin{tabular}{cc}
		\fbox{\includegraphics[width=0.25\textwidth]{results/rgbd_dataset_freiburg3_cabinet.png}} \\[2ex] \fbox{\includegraphics[width=0.25\textwidth]{results/rgbd_dataset_freiburg3_teddy.png}}
	\end{tabular}
	\caption{

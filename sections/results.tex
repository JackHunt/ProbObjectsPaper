...
\begin{figure}[!t]
	...
	\begin{tabular}{cc}
		...
		\fbox{\includegraphics[width=0.2\textwidth]{results/comparative_cabinet.png}} &
		\fbox{\includegraphics[width=0.2\textwidth]{results/comparative_teddy_clean.png}}
	\end{tabular}
	\caption{
...
\begin{figure*}[!t]
	\centering
	\begin{tabular}{cccc}
		\fbox{\includegraphics[width=3cm]{screenshots/untextured/teddy_top00.png}}&
		\fbox{\includegraphics[width=3cm]{screenshots/untextured/dino_top00.png}}&
		\fbox{\includegraphics[width=3cm]{screenshots/untextured/chair_top00.png}}&
		\fbox{\includegraphics[width=3cm]{screenshots/untextured/rock_top00.png}}\\
		(a) & (b) & (c) & (d)
	\end{tabular}
	\caption{
...
\begin{figure*}[!t]
	\centering
	\begin{tabular}{cccc}
		\fbox{\includegraphics[width=3cm]{screenshots/Comparison Stills/InfiniTAM/bear00.png}}&
		\fbox{\includegraphics[width=3cm]{screenshots/Comparison Stills/InfiniTAM/brain00.png}}&
		\fbox{\includegraphics[width=3cm]{screenshots/Comparison Stills/InfiniTAM/chair00.png}}&
		\fbox{\includegraphics[width=3cm]{screenshots/Comparison Stills/InfiniTAM/dino00.png}}\\
		(a)&(b)&(c)&(d) \\ 
		\fbox{\includegraphics[width=3cm]{screenshots/Comparison Stills/ProbObjects/bear00.png}}&
		\fbox{\includegraphics[width=3cm]{screenshots/Comparison Stills/ProbObjects/brain00.png}}&
		\fbox{\includegraphics[width=3cm]{screenshots/Comparison Stills/ProbObjects/chair00.png}}&
		\fbox{\includegraphics[width=3cm]{screenshots/Comparison Stills/ProbObjects/dino00.png}}\\
		(e)&(f)&(g)&(h) \\ 
	\end{tabular}
	\vspace{1mm}
	\caption{

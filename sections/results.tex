...
\begin{figure}[!t]
	\centering
	\begin{tabular}{cccc}
		\bmvaHangBox{\fbox{\includegraphics[scale=0.15]{results/rgbd_dataset_freiburg3_cabinet.png}}}&
		\bmvaHangBox{\fbox{\includegraphics[scale=0.15]{results/rgbd_dataset_freiburg3_teddy.png}}}&\\
		(a)&(b)
	\end{tabular}
	\caption{
...
\begin{figure}[!t]
	\centering
	\begin{tabular}{cccc}
		\bmvaHangBox{\fbox{\includegraphics[scale=0.2]{filmstrips/dino.png}}}&\\
		(a)\\
		\bmvaHangBox{\fbox{\includegraphics[scale=0.2]{filmstrips/dino_s3d_large.png}}}&\\
		(b)
	\end{tabular}
	\caption{
...
\begin{figure}[!t]
	\centering
	\begin{tabular}{cccc}
		\bmvaHangBox{\fbox{\includegraphics[width=2.5cm]{screenshots/dino_colour_top.PNG}}}&
		\bmvaHangBox{\fbox{\includegraphics[width=2.5cm]{screenshots/chair_colour_top.PNG}}}&
		\bmvaHangBox{\fbox{\includegraphics[width=2.5cm]{screenshots/rock_colour_top.PNG}}}\\
		(a)&(b)&(c)
	\end{tabular}
	\caption{

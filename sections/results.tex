...
\begin{figure*}[!t]
	\centering
	\begin{tabular}{ccc}
		\fbox{\includegraphics[width=0.2\textwidth]{screenshots/dino_colour_top_grey.PNG}}&
		\fbox{\includegraphics[width=0.2\textwidth]{screenshots/chair_colour_top_grey.PNG}}&
		\fbox{\includegraphics[width=0.2\textwidth]{screenshots/rock_colour_top_grey.PNG}}
	\end{tabular}
	\caption{

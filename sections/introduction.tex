...
\begin{figure*}[!t]
	\centering
	\begin{tabular}{cccc}
		\fbox{\includegraphics[width=3cm]{screenshots/bear_colour_grey.PNG}}&
		\fbox{\includegraphics[width=3cm]{screenshots/chair_colour_grey.PNG}}&
		\fbox{\includegraphics[width=3cm]{screenshots/dino_colour_grey.PNG}}&
		\fbox{\includegraphics[width=3cm]{screenshots/rock_colour_grey.PNG}}\\
		(a)&(b)&(c)&(d)
	\end{tabular}
	\vspace{1mm}
	\caption{

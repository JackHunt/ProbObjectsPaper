...
\begin{figure*}[!t]
	\centering
	\begin{tabular}{cccc}
		\fbox{\includegraphics[width=3cm]{screenshots/bear_colour.PNG}}&
		\fbox{\includegraphics[width=3cm]{screenshots/chair_colour.PNG}}&
		\fbox{\includegraphics[width=3cm]{screenshots/dino_colour.PNG}}&
		\fbox{\includegraphics[width=3cm]{screenshots/rock_colour.PNG}}\\
		(a)&(b)&(c)&(d)
	\end{tabular}
	\vspace{1mm}
	\caption{

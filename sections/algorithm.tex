...
New subvolumes are started when sufficiently many new voxels have been allocated and had data integrated. By ensuring overlap 
between the subvolumes, transformations between them can be found and pose inconsistencies addressed.
...
\begin{figure}[!t]
	\centering
	\subfigure[]{\includegraphics{graphical_models/pgm1.pdf}\label{pgm1}}%
	\hspace{12mm}%
	\subfigure[]{\includegraphics{graphical_models/pgm2.pdf}\label{pgm2}}

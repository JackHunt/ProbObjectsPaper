...
At each frame a smaller, image sized volume \STUART{What do you mean by image-sized volume here?} is constructed based on the predictions of the model given the current frame. During the fusion process, this 

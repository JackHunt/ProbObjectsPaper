...
however, the overall object surface $\mathbf{\Phi}$ is implicitly deformed by a combining function $\mathbf{\zeta}(\mathbf{\Phi})$ over each of the subvolumes to which transformations have been applied.

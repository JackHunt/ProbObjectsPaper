...
\STUART{Meh! -- the `surfels are bad' argument is a weak argument, because the real problem here is the pose estimation / loop closure. If you can get that to work, then you can construct whatever representation you like. The bottom line is that we need to beat these guys fair and square: we can't dodge the bullet by saying that they use a different representation.}